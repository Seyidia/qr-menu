    ...
    <div className={`min-h-screen transition-all duration-300 ${
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`pl-10 pr-4 py-2 rounded-full border transition-all duration-200 focus:ring-2 focus:ring-indigo-500 focus:border-transparent ${
                    darkMode 
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Sidebar Categories - Sol tarafa alındı */}
          <aside className="lg:w-64 flex-shrink-0">
            <div className={`sticky top-24 p-6 rounded-2xl border transition-all duration-300 ${
              ...
              <h2 className="text-xl font-bold mb-4 text-indigo-600">Kategoriler</h2>
                ...
                {categories.map((category) => (
                  ...
                  >
                    ...
                    <span className={`ml-2 text-xs ${
                      activeCategory === category ? 'text-blue-200' : 'text-gray-500'
                    }`}>
          ...
          <main className="flex-1">
            <div className="mb-8">
              <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent">
                {activeCategory}
              </h2>
                ...
                {filteredProducts.map((item) => (
                  ...
                  >
                    <div className="relative overflow-hidden">
                      <img
                        src={item.img || `https://via.placeholder.com/300x160/6366F1/FFFFFF?text=${encodeURIComponent(item.name)}`}
                        alt={item.name}
